...
#
# tcl_file.tcl: Tcl script for re-creating project 'EHDProjFinal'
#
# Generated by Vivado on Tue Dec 04 15:21:05 +0530 2018
...
#
# 1. This project restoration tcl script (tcl_file.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "E:/IIITH/sem3/ehd/FinalProj/EHDProjFinal/EHDProjFinal.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "E:/IIITH/sem3/ehd/FinalProj/EHDProjFinal/EHDProjFinal.srcs/constrs_1/new/constrain.xdc"
#
...
set orig_proj_dir "[file normalize "$origin_dir/E:/IIITH/sem3/ehd/FinalProj/EHDProjFinal"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/E:/IIITH/sem3/ehd/FinalProj/ip_repo/ayuIPFinal_1.0"]" $obj
...
set files [list \
 "[file normalize "$origin_dir/E:/IIITH/sem3/ehd/FinalProj/EHDProjFinal/EHDProjFinal.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]"\
]
...
set file "[file normalize "$origin_dir/E:/IIITH/sem3/ehd/FinalProj/EHDProjFinal/EHDProjFinal.srcs/constrs_1/new/constrain.xdc"]"
...
set_property -name "target_constrs_file" -value "[get_files *new/constrain.xdc]" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:ayuIPFinal:1.0\
  ...
  # Create instance: ayuIPFinal_0, and set properties
  set ayuIPFinal_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ayuIPFinal:1.0 ayuIPFinal_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {90.900002} \
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {199.979996} \
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {199.979996} \
   ...
   CONFIG.PCW_ACT_UART_PERIPHERAL_FREQMHZ {49.994999} \
   ...
   CONFIG.PCW_IO_IO_PLL_FREQMHZ {999.900} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ayuIPFinal_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ayuIPFinal_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ayuIPFinal_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ayuIPFinal_0/S00_AXI/S00_AXI_reg] SEG_ayuIPFinal_0_S00_AXI_reg
